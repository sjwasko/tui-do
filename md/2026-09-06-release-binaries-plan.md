...
Run the README's own install commands from Task 4, with `tag=v1.0.0-rc.1`, on **`sw-x280`**
(x86_64), **`sw-pi`** (aarch64), and the **PocketTerm35**. Using the README's commands rather
...
hand-driving on `sw-x280`/`sw-pi`/PocketTerm35 including the 32-bit check (Task 6). No spec
