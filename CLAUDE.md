...
| | |
|---|---|
| **Dev server** | `https://sw-surface.tail9803a5.ts.net:8443` — use this for everything |
| **Prod server** | `https://sw-hp2.tail9803a5.ts.net:8443` — **read-only, always.** Never a write target, never a test target |
