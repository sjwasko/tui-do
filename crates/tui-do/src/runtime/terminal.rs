...
//!
//! Raw mode and the alternate screen are process-global state. If tui-do exits without
...
impl TerminalGuard {
    ...
    pub fn take() -> anyhow::Result<Self> {
        ...
        // A blinking block, not the terminal's default. tui-do shows a cursor only where
