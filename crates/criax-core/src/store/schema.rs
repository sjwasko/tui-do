...
//!
//! Vikunja spells "unset" as Go's zero time because its columns are `NOT NULL`. criax has
        ...
        return Err(crate::CoreError::Config {
            ...
            reason: format!(
                "this database is at schema version {current}, newer than the {target} \
                 this build of criax understands. Use a newer criax, or move the file \
...
mod tests {
    ...
    #[test]
    fn a_database_from_a_newer_criax_is_refused_rather_than_used() {
