...
mod tests {
    ...
    fn the_dev_server_url_resolves_as_expected() {
        let client = client("https://sw-surface.tail9803a5.ts.net:8443");
        assert_eq!(
            client.resolve(endpoints::TASKS, &[]).unwrap().as_str(),
            "https://sw-surface.tail9803a5.ts.net:8443/api/v1/tasks"
        );
        assert_eq!(
            client
                ...
                .unwrap()
                .as_str(),
            "https://sw-surface.tail9803a5.ts.net:8443/api/v1/tasks/42"
        );
        assert_eq!(
            client
                ...
                .unwrap()
                .as_str(),
            "https://sw-surface.tail9803a5.ts.net:8443/api/v1/projects/3/views/7/tasks"
        );
    }
