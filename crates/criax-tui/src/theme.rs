...
//! knows whether it is talking to a truecolor terminal, and `criax-tui` stays a pure
...
/// what a terminal looks like. criax paints foregrounds and selections only.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
pub struct Theme {
    depth: ColorDepth,
}
...
impl Theme {
    ...
    ///
    /// Vikunja only draws attention from 3 upwards, and so does criax: colouring "low"
